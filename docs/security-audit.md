# Security audit — mesh-favor-bank

Generated: **2026-05-17T13:28:32.575Z** · 16 checks · 16 pass · 0 fail
...
```json
{
  "pubkeyA": "73d9cd31332ba010c93ac76d882cf6ec8e099665616f0a566766ff1feb5dd580",
  "pubkeyB": "73d9cd31332ba010c93ac76d882cf6ec8e099665616f0a566766ff1feb5dd580"
}
```
...
```json
{
  "pubkeyA": "eebd642c1103830c",
  "pubkeyB": "941ad1e857018252"
}
```
...
```json
{
  "plantedExpiresAt": 1779024452569,
  "now": 1779024512572
}
```
...
```json
{
  "realPubkey": "f2bf15501d775e70",
  "forgerPubkey": "00222c52df12fca6"
}
```
...
```json
{
  "forgedPubkey": "6d875cd926b035d8",
  "realPubkey": "96b41b2e0e736e70"
}
```
