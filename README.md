...
**Live → https://baditaflorin.github.io/mesh-favor-bank/**

**Source → https://github.com/baditaflorin/mesh-favor-bank**
...
git clone https://github.com/baditaflorin/mesh-favor-bank
cd mesh-favor-bank
npm install
npm run dev
```
...
- `mesh-favor-bank:signalingUrl`
- `mesh-favor-bank:turnTokenUrl`
- `mesh-favor-bank:iceServers`
- `mesh-favor-bank:room`
